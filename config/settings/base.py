...
TEMPLATE_ID_LEAVER_NOT_IN_UKSBS_HR_REMINDER = env(
    "TEMPLATE_ID_LEAVER_NOT_IN_UKSBS_HR_REMINDER", default=None
)
TEMPLATE_ID_LEAVER_NOT_IN_UKSBS_LM_REMINDER = env(
    "TEMPLATE_ID_LEAVER_NOT_IN_UKSBS_LM_REMINDER", default=None
)
TEMPLATE_ID_LINE_MANAGER_CORRECTION_EMAIL = env(
    "TEMPLATE_ID_LINE_MANAGER_CORRECTION_EMAIL", default=None
)
TEMPLATE_ID_LINE_MANAGER_CORRECTION_HR_EMAIL = env(
    "TEMPLATE_ID_LINE_MANAGER_CORRECTION_HR_EMAIL", default=None
)
TEMPLATE_ID_LINE_MANAGER_CORRECTION_REPORTED_LM_EMAIL = env(
    "TEMPLATE_ID_LINE_MANAGER_CORRECTION_REPORTED_LM_EMAIL", default=None
)
...
TEMPLATE_ID_IT_OPS_ASSET_EMAIL = env("TEMPLATE_ID_IT_OPS_ASSET_EMAIL", default=None)
...
TEMPLATE_ID_SECURITY_TEAM_OFFBOARD_BP_LEAVER_EMAIL = env(
    "TEMPLATE_ID_SECURITY_TEAM_OFFBOARD_BP_LEAVER_EMAIL", default=None
)
TEMPLATE_ID_SECURITY_TEAM_OFFBOARD_RK_LEAVER_EMAIL = env(
    "TEMPLATE_ID_SECURITY_TEAM_OFFBOARD_RK_LEAVER_EMAIL", default=None
)
