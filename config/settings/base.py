...
UKSBS_API_URL = env("UKSBS_API_URL", default=None)
...
# Email Templates
LEAVER_THANK_YOU_EMAIL_TEMPLATE_ID = env(
    "LEAVER_THANK_YOU_EMAIL_TEMPLATE_ID", default=None
)
...
LINE_MANAGER_CORRECTION_EMAIL_TEMPLATE_ID = env(
    "LINE_MANAGER_CORRECTION_EMAIL_TEMPLATE_ID", default=None
)
