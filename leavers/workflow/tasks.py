...
from core.lsd_helpdesk import get_lsd_helpdesk_interface
...
class LSDSendLeaverDetails(LeavingRequestTask):
    ...
    def execute(self, task_info):
        lsd_helpdesk_interface = get_lsd_helpdesk_interface()
        lsd_helpdesk_interface.inform_lsd_team_of_leaver(
